package com.renard.common.baseadapter;
...
import com.renard.common.baseadapter.foot.LoadMoreFooterView;
import com.renard.common.baseadapter.foot.OnLoadMoreListener;
import com.renard.common.baseadapter.foot.OnLoadMoreScrollListener;
import com.renard.common.baseadapter.refresh.OnRefreshListener;
import com.renard.common.baseadapter.refresh.RefreshHeaderLayout;
import com.renard.common.baseadapter.refresh.RefreshTrigger;
import com.renard.common.baseadapter.swipeview.SwipeMenuRecyclerView;
import com.renard.common.customview.swipe.CustomSwipeRefreshLayout;
...
public class SuperRecyclerView extends SwipeMenuRecyclerView {
    ...
    public void removeEmptyView() {
        if (mEmptyViewContainer != null) {
            mEmptyViewContainer.removeAllViews();
            mEmptyViewContainer.setLayoutParams(new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    private void ensureRefreshHeaderContainer() {
        if (mRefreshHeaderContainer == null) {
            ...
            mRefreshHeaderContainer.setLayoutParams(new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 0));
        }
    }
