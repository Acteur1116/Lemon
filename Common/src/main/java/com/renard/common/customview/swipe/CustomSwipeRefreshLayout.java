...
package com.renard.common.customview.swipe;
...
public class CustomSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    @VisibleForTesting
    static int CIRCLE_DIAMETER = 30;
    @VisibleForTesting
    static int CIRCLE_DIAMETER_LARGE = 40;
    ...
    /**
     * Set a callback to override {@link CustomSwipeRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    public static interface OnChildScrollUpCallback {
         ...
         */
        public boolean canChildScrollUp(CustomSwipeRefreshLayout parent, @Nullable View child);
    }
}
